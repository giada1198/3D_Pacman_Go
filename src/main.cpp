...
void IntToChar(int input,std::string header,std::string footer,char* charArray){
      std::stringstream ss;
      ss << input;
      std::string output;
      output = ss.str();
...
int main(void){
    ...
    if (YSOK != pacman_death.LoadWav("../sounds/pacman_death.wav") &&
        YSOK != pacman_death.LoadWav("../sounds/pacman_death.wav"))
    {
        printf("Error!  Cannot load pacman_death.wav!\n");
    }
    if (YSOK != scene.LoadWav("../sounds/scene.wav") &&
        YSOK != scene.LoadWav("../sounds/scene.wav"))
    {
        printf("Error!  Cannot load scene.wav!\n");
    }
    if (YSOK != cherry.LoadWav("../sounds/pacman_eatfruit.wav") &&
        YSOK != cherry.LoadWav("../sounds/pacman_eatfruit.wav"))
    {
        printf("Error!  Cannot load pacman_eatfruit.wav!\n");
    }
    if (YSOK != areyouready.LoadWav("../sounds/areyouready.wav") &&
        YSOK != areyouready.LoadWav("../sounds/areyouready.wav"))
    {
        printf("Error!  Cannot load areyouready.wav!\n");
    }
